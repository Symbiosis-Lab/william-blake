...
source: "John Sampson, ed., *The Poetical Works of William Blake* (Oxford: Clarendon Press, 1905), pp. 274–279. Public domain."
ocr_note: "Sampson's interleaved textual apparatus, cross-references and stanza-footnote marks are omitted, leaving the 26 quatrains in his printed order. One evident OCR letter-substitution corrected: \"roli'd\" to \"roll'd\" (stanza 22). The printed page's French spacing before \";\" and \":\" (a typesetting convention, not Blake's punctuation) has been normalised to no space."
---
