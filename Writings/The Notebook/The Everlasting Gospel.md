...
source: "John Sampson, ed., *The Poetical Works of William Blake* (Oxford: Clarendon Press, 1913), pp. 146–158. Public domain. OCR via Internet Archive poeticalworksofw0000will_l0j4."
ocr_note: Blake left this poem in separate, overlapping passages scattered through the Notebook, never assembled into one finished text or engraved; Sampson's headnote dates the draft to around 1810, though the poem is usually dated to Blake's final years, c. 1818, on the evidence of the Notebook pages around it, and that later date is kept here. Sampson's apparatus (his lettered sections for cross-reference, manuscript variants, and textual-history notes) is omitted, leaving his single consolidated reading of the poem's passages in order; a short prose fragment Sampson prints only in a note, beginning "This was spoken by my Spectre to Voltaire, Bacon, &c.," and a trailing "What are those..." that opens onto Sampson's own collation note rather than continuing Blake's verse, are likewise omitted as apparatus rather than verse.
---
